...
const courses = [
    ...
    {
        icon: <ShieldCheckIcon className="w-10 h-10 text-cyan-400 mx-auto" />,
    ...
    {
        icon: <DeviceMobileIcon className="w-10 h-10 text-cyan-400 mx-auto" />,
    ...
    {
        icon: <DatabaseIcon className="w-10 h-10 text-cyan-400 mx-auto" />,
    ...
    {
        icon: <CloudIcon className="w-10 h-10 text-cyan-400 mx-auto" />,
            ...
            <main className="bg-gray-900 min-h-screen py-16 px-4">
                ...
                <div className="max-w-5xl mx-auto mb-10 flex flex-col sm:flex-row items-center gap-4">
                    <input
                        ...
                        className="flex-1 px-4 py-3 rounded-lg bg-gray-800 text-gray-200 placeholder-gray-400 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                    />
                    <select
                        className="px-4 py-3 rounded-lg bg-gray-800 text-gray-200 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                        defaultValue=""
                    >
                ...
                <section className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {courses.map((course, idx) => (
                            <div
                                key={idx}
                                className="bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition duration-200 transform hover:-translate-y-2 shadow-lg"
                            >
