...
//     const url = currentJob._id ? `https://hackerworld.onrender.com/api/careers/${currentJob._id}` : "https://hackerworld.onrender.com/api/careers";
...
//     fetch(`https://hackerworld.onrender.com/api/careers/${id}`, { method: "DELETE" })
//       .then(res => {
